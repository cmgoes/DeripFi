            ...
            {isMobile ?
              <>
                ...
                {!removed && (
                  <SpanElement>
                    ...
                    <SpanElement style={{ fontFamily: "Ubuntu", fontSize: 14 }}>APR:</SpanElement> <SpanElement style={{ fontFamily: "Ubuntu", fontSize: 18 }}>{displayApr}%</SpanElement>
                    <ApyButton
                      lpLabel={lpLabel}
              ...
              <>
                ...
                {!removed && (
                  <h2>
                    {/* <span>APR:</span> {displayApr}% */}
                    <span style={{ fontFamily: "Ubuntu", fontSize: 14 }}>APR:</span> <h2 style={{ fontFamily: "Ubuntu", fontSize: 18 }}>{displayApr}%</h2>
                    <ApyButton
                      lpLabel={lpLabel}
                      addLiquidityUrl={addLiquidityUrl}
                      cakePrice={cakePrice}
