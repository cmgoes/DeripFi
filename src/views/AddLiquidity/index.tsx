  ...
  const modalHeader = () => {
    return noLiquidity ? (
      <Flex alignItems="center">
        <Text fontSize="48px" marginRight="10px" color="#086770" fontFamily="UbuntuBold">
      ...
      <AutoColumn>
        ...
        <Row>
          <Text fontSize="24px" color="#086770" fontFamily="UbuntuBold">
            {`${currencies[Field.CURRENCY_A]?.symbol}/${currencies[Field.CURRENCY_B]?.symbol} Pool Tokens`}
          </Text>
        </Row>
        <Text small textAlign="left" fontStyle="italic" color="#086770" my="24px" fontFamily="UbuntuBold">
